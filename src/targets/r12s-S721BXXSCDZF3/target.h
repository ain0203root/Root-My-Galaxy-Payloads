...
// Убираем APP_DEFAULT_FAST_KSNITCH — он мешает поиску mm_struct
...
// Убираем APP_KERNEL_PAGE_KSNITCH_IDENTITY_END и APP_KERNEL_PAGE_KSNITCH_EXACT_PARTITION
...
#define APP_FOPS_MIN_OBJECT_INDEX 12   // возвращаем ваше значение
